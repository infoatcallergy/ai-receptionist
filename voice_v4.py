...
# ---------------------------------------------------
# 2️⃣ MAIN CONVERSATION LOOP (no speech, just listen)
# ---------------------------------------------------
...
# ---------------------------------------------------
# 3️⃣ PROCESS AUDIO → memory/intent → GPT → ElevenLabs → PLAY
...
# ---------------------------------------------------
# 4️⃣ PROACTIVE FOLLOW-UP: the AI speaks next (no recording first)
